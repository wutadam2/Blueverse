...
class Community(models.Model):
	...
	platform = models.SmallIntegerField(default=0, choices=((0, 'none'), (1, '3ds'), (2, 'wii u'), (3, 'switch'), (4, 'both')))
...
class Ads(models.Model):
	id = models.AutoField(primary_key=True)
	created = models.DateTimeField(auto_now_add=True)
	url = models.TextField(default='', null=False, blank=False)
	imageurl = models.TextField(default='', null=False, blank=False)
