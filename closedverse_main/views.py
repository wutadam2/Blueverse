...
def community_list(request):
	...
	return render(request, 'closedverse_main/community_list.html', {
		...
		'ogdata': {
				...
				'description': "closedverse rehost my god",
				'date': 'None',
...
def help_rules(request):
	return render(request, 'closedverse_main/help/rules.html', {'title': 'Blueverse Rules'})
...
def help_why(request):
	return render(request, 'closedverse_main/help/why.html', {'title': "Why even join Blueverse?"})
